```{r Validation rule 23: "The surgical procedure has an invalid first side procedure code"}
      ...
      left_join(
        data$surgeries |>
          select(
            ...
            NEOIPC_SURGERY_SIDE_PROCEDURE_CODE_1) |>
          rename(
            EVENT_ID = event,
            EVENT_DATE = occurredAt,
            PROCEDURE_DESCRIPTION = NEOIPC_SURGERY_PROCEDURE_DESCRIPTION,
            PROCEDURE_CODE = NEOIPC_SURGERY_SIDE_PROCEDURE_CODE_1),
