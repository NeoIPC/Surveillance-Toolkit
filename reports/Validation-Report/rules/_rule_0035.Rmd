```{r Validation rule 35: "The day of life stored in the nec event does not match the calculated value"}
problems <- problems |>
  bind_rows(
    patients |>
      ...
      mutate(
        ...
        NEC_DOL_CALCULATED = NEOIPC_ADMISSION_DOL + as.integer(EVENT_DATE - ENROLMENT_DATE)) |>
      filter(NEC_DOL_CALCULATED != NEOIPC_NEC_DOL) |>
      select(
        SITE_CODE,
        DEPARTMENT_CODE,
        DEPARTMENT_NAME,
