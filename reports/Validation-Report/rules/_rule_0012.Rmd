```{r Validation rule 12: "The patient record contains a sepsis form with an infection date that is not within the time frame of a documented enrolment."}
