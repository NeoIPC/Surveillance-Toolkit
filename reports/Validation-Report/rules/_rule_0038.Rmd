```{r Validation rule 38: "The day of the nec event is less than day 3 of the hospital stay of a transferred or re-admitted patient"}
problems <- problems |>
  bind_rows(
    patients |>
