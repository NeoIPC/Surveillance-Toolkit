...
Number of departments contributing at least one patient record:

:   `r dR$numberOfDepartments`

Number of patient records:

:   `r dR$numberOfPatients`

Number of patient admissions:

:   `r dR$numberOfAdmissions`

Sum of patient days:

:   `r dR$sumOfPatientDays`

Average surveillance period per patient:

:   `r dR$averageSurveillancePeriod` days
