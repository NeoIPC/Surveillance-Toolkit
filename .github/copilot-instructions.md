...
This file documents the Surveillance-Toolkit repository. If this repository is checked out as a submodule of the `neoipc-workspace`, see the workspace-level `.github/copilot-instructions.md` for cross-cutting instructions.
